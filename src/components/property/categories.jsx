...
const Categories = ({ dataCategory, setCategory }) => {
  const categoryData = [
    ...
    {
      imageUrl:
        "https://a0.muscache.com/pictures/8b8b36e4-b4e1-471e-82d5-1a2f48ac0a2e.jpg",
    ...
    <div className="row g-3 overflow-auto" style={{ maxHeight: "750px" }}>
      ...
      <div className="col-12 col-sm-6 col-md-4 d-flex justify-content-center">
        <div
          ...
          className={`text-center p-3 category-item d-flex flex-column align-items-center justify-content-center rounded ${
            dataCategory === "" ? "border border-dark" : "border border-light"
          } opacity-75`}
          style={{
            cursor: "pointer",
            transition: "all 0.3s",
